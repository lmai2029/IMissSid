...
void Camera_init(void){
	...
	IOMUX->SECCFG.PINCM[IOMUX_PINCM3]|= IOMUX_PINCM_PC_MASK|IOMUX_PINCM_PIPD_DISABLE|IOMUX_PINCM_PIPU_DISABLE;
	IOMUX->SECCFG.PINCM[IOMUX_PINCM34]|= IOMUX_PINCM_PC_MASK|IOMUX_PINCM_PIPD_DISABLE|IOMUX_PINCM_PIPU_DISABLE;
